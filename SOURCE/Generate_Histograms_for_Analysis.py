...
if __name__ == '__main__':
    experiment_name="nx540_no_interpolation_in_iX_yes_recentering_average_nx_540_iX_378_angles_rad"
    ...
    def plot_histograms_for(variable):
    ...
    plot_histograms_for('R0')
    plot_histograms_for('w0')
    plot_histograms_for('interpolation')
    plot_histograms_for('averaged_images_or_angles')
    plot_histograms_for('best_algorithm')
