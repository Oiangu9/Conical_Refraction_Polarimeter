...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(9, 9, 1211, 611))
        ...
        self.tabWidget_2.setGeometry(QtCore.QRect(9, 0, 1191, 591))
        ...
        self.brute_rot.setGeometry(QtCore.QRect(30, 280, 231, 32))
        self.brute_rot.setObjectName("brute_rot")
        self.fibonacci_rot = QtWidgets.QRadioButton(self.tab_4)
        self.fibonacci_rot.setGeometry(QtCore.QRect(30, 340, 271, 32))
        self.fibonacci_rot.setObjectName("fibonacci_rot")
        self.quadratic_rot = QtWidgets.QRadioButton(self.tab_4)
        self.quadratic_rot.setGeometry(QtCore.QRect(30, 390, 251, 61))
        self.quadratic_rot.setChecked(False)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(360, 350, 321, 151))
        self.groupBox_3.setObjectName("groupBox_3")
        self.label_14 = QtWidgets.QLabel(self.groupBox_3)
        self.label_14.setGeometry(QtCore.QRect(40, 40, 181, 16))
        self.label_14.setObjectName("label_14")
        self.intial_guess_delta = QtWidgets.QLineEdit(self.groupBox_3)
        self.intial_guess_delta.setGeometry(QtCore.QRect(230, 40, 71, 23))
        self.intial_guess_delta.setObjectName("intial_guess_delta")
        ...
        self.label.setGeometry(QtCore.QRect(30, 230, 251, 31))
        self.label.setObjectName("label")
        self.run_rotation_algorithm = QtWidgets.QPushButton(self.tab_4)
        self.run_rotation_algorithm.setGeometry(QtCore.QRect(120, 490, 121, 41))
        ...
        self.output_plots_rot = QtWidgets.QRadioButton(self.tab_4)
        self.output_plots_rot.setGeometry(QtCore.QRect(30, 60, 100, 21))
        self.output_plots_rot.setChecked(True)
        self.output_plots_rot.setAutoExclusive(False)
        self.output_plots_rot.setObjectName("output_plots_rot")
        self.show_plots_rot = QtWidgets.QRadioButton(self.tab_4)
        self.show_plots_rot.setGeometry(QtCore.QRect(180, 60, 100, 21))
        self.show_plots_rot.setAutoExclusive(False)
        self.show_plots_rot.setObjectName("show_plots_rot")
        self.use_current_images_rot = QtWidgets.QRadioButton(self.tab_4)
        self.use_current_images_rot.setGeometry(QtCore.QRect(30, 110, 271, 21))
        self.use_current_images_rot.setChecked(True)
        self.use_current_images_rot.setObjectName("use_current_images_rot")
        self.use_output_dir_images_rot = QtWidgets.QRadioButton(self.tab_4)
        self.use_output_dir_images_rot.setGeometry(QtCore.QRect(30, 160, 261, 31))
        self.use_output_dir_images_rot.setObjectName("use_output_dir_images_rot")
        self.label_13 = QtWidgets.QLabel(self.tab_4)
        self.label_13.setGeometry(QtCore.QRect(330, 510, 751, 41))
        ...
        self.log_text.setGeometry(QtCore.QRect(20, 630, 1191, 171))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.intial_guess_delta.setText(_translate("MainWindow", "0.1"))
        ...
        self.output_plots_rot.setText(_translate("MainWindow", "Output Plots"))
        self.show_plots_rot.setText(_translate("MainWindow", "Show Plots"))
        self.use_current_images_rot.setText(_translate("MainWindow", "Use Converted Images in current session"))
        self.use_output_dir_images_rot.setText(_translate("MainWindow", "Use all Converted Images in \n"
